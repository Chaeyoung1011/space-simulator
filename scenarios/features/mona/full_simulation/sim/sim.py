...
from scenarios.features.mona.full_simulation.sim.super_task import SuperTask
...
def generate_super_tasks(tasks: list) -> list:
    ...
    """
    from scenarios.features.mona.full_simulation.sim.super_task import size_for_count
